...
namespace MonkFixPlexDB
{
    public class Options
    {
        ...
        [Option('g', "debug", Required = false, HelpText = "Set output to debug messages.")]
        public bool Debug { get; set; }

        [Option('f', "forcerestartsection", Required = false, HelpText = "Force a restart of the section from item 0.")]
